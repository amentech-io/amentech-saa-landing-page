    ...
    <div class="absolute inset-0 flex -z-2">
      ...
      <div class="grid grid-cols-2 flex-auto place-items-center">
        ...
        <div
          ...
          class="aspect-1 translate-x-[100%] w-100 rounded-full bg-[#FC5185]/30 blur-200"
        />
      </div>
      <div class="my-auto mr-25">
        <img src="/hero-bg-left.png" alt="">
      </div>
    </div>
    <div v-motion-slide-left class="mx-auto">
      <h1
        class="max-w-30ch text-center text-8 font-bold leading-8 lg:text-7xl lg:leading-24"
        v-html=" t('title')"
      />
      ...
      <div class="flex justify-center">
        <NuxtLink
          class="mt-4 inline-block rounded-5 from-[#1C57BC] via-[#9D5CA2] to-[rgba(252,81,133,0.94)] from-0% to-98% via-47% bg-gradient-to-l px-10 py-2 font-semibold text-white transition lg:mt-15 lg:px-18 lg:py-5 lg:text-lg hover:opacity-90 hover:ring-4 hover:ring-white/50"
          to="contact"
        >
          {{ $t('contact-us') }}
        </NuxtLink>
